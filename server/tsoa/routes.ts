...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { ClothMarkController } from './../api/controllers/cloth/cloth-mark-controller';
...
const models: TsoaRoute.Models = {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "ShoppingSuccessResponse_ClothMarkViewModel-Array_": {
        "dataType": "refObject",
        "properties": {
            "data": {"dataType":"array","array":{"dataType":"refObject","ref":"ClothMarkViewModel"},"required":true},
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/cloth/all',
            ...
            function ClothMarkController_getClothMarkAll(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.getClothMarkAll.apply(controller, validatedArgs as any);
        ...
        app.post('/cloth/info',
            ...
            function ClothMarkController_postClothMarkInfo(request: any, response: any, next: any) {
            const args = {
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"ClothMarkRequest"},
                    request: {"in":"request","name":"request","required":true,"dataType":"object"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.put('/cloth/info/:id',

            function ClothMarkController_putClothMarkInfo(request: any, response: any, next: any) {
            const args = {
                    request: {"in":"request","name":"request","required":true,"dataType":"object"},
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"ClothMarkRequest"},
            ...
            try {
              ...
              const promise = controller.putClothMarkInfo.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
